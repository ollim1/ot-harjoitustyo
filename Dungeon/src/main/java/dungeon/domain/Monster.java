...
/**
 * This class is the primary enemy of the game. AI should probably be refactored
 * into another class.
 */
public class Monster extends Actor {
    ...
    /**
     * Raises an alert if the monster is within range. The range of sight is
     * relative to the player's field of view, so a shorter field of view will
     * result in a smaller safety margin.
     *
     * @param game
     */
     ...
     * moving when HP is above threshold.
     *
     * @param game
